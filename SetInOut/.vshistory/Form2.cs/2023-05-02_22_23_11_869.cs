...
namespace SetInOut
{
    public partial class Form2 : Form
    {
                ...
                else
                {
                    ...
                    switch (enumerator.Current)
                    {
                        case ';':
                            ...
                            Form2.istrList[this.numIstr] = new istruzione(r);
                            ++this.numIstr;
                            break;
                        case 'D':
                            ...
                            this.listBox1.Items.Add((object)r);
                            Form2.istrList[this.numIstr] = new istruzione('D', int32_1, r);
                            ++this.numIstr;
                            break;
                        case 'I':
                        case 'O':
                            ...
                            if (flag)
                            {
                                ...
                                if (current2 == '1' || current2 == '0')
                                {
                                    ...
                                    this.listBox1.Items.Add((object)r);
                                    Form2.istrList[this.numIstr] = new istruzione(current1, int32_2, this.LivelloLogico(current2), r);
                                    ++this.numIstr;
                                    break;
                                }
        ...
        {
            this.Text = this.FormTitle + " - " + nuovoNomeFile;
            int num = 35;
            if (this.Text.Length < num)
                return;
            this.Text = this.FormTitle + " - ..." + nuovoNomeFile.Substring(nuovoNomeFile.Length - num);
        }
