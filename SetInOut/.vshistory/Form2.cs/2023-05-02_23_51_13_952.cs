...
namespace SetInOut
{
    public partial class Form2 : Form
    {
        ...
        private bool VerifySyntax1()
        {
                    ...
                    switch (enumerator.Current)
                    {
                        ...
                        case 'W': //Output
                            ...
                            if (flag)
                            {
                                ...
                                // Check if Q or W is equal to 1 or 0
                                bool qOrWValue = this.LivelloLogico(current2);
                                if ((current1 == 'Q' || current1 == 'W') && (qOrWValue == 1 || qOrWValue == 0))
                                {
                                    if (qOrWValue == 1)
                                    {
                                        // Do something if Q or W is equal to 1
                                    }
                                    else
                                    {
                                        // Do something if Q or W is equal to 0
                                    }
                                }

                                if (current2 == '1' || current2 == '0')
                                {
                                    Form2.istrList[this.numIstr] = new Instruct(current1, int32_2, current2);
                                    ++this.numIstr;
                                }
                                else
                                {
                                    this.listBox1.Items.Add((object)(r + " <- errore: il valore logico deve essere '1' o '0'"));
                                    flag = false;
                                }
                                break;
                            }
            ...
            default:
                            this.listBox1.Items.Add((object)(r + " <- errore: prima colonna non valida"));
                            flag = false;
                            break;
                    }
                }
