...
namespace SetInOut
{
    public partial class Form1 : Form
    {
        ...
        //private List<string> recentFiles = LoadRecentFilesFromRegistry();
        ...
        private void addlist()
        {
            foreach (string file in recentFiles)
            {
                ...
                FiletSDDB.DropDownItems.Add(menuItem);
            }
        }
        ...
        private void LoadRecentFilesMenu(List<string> recentFiles)
        {
           ...
           // FiletSDDB.DropDownItems.Clear();
            ...
            foreach (string filePath in recentFiles)
            {
                ...
                // Set the Text property to the file name or a shortened version of it
